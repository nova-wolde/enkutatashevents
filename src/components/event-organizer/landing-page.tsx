                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div><label className="text-xs sm:text-sm font-medium mb-1.5 block">{t('Event Type', 'የዝግጅት አይነት')}</label><Input placeholder={t('Wedding, Corporate, etc.', 'ሠርግ፣ ኮርፖሬት፣ ወዘተ')} value={formState.eventType} onChange={(e) => setFormState({ ...formState, eventType: e.target.value })} className="h-10 sm:h-11 min-h-[44px]" /></div>
                    </div>
